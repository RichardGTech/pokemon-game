...
var gameState = {
  ...
  init: function init() {
    ...
    while (i < gameState.elements.pokemonsEl.length) {
      ...
      gameState.elements.pokemonsEl[i].onclick = function () {
        ...
        gameState.currentPokemon[0].health = gameState.calcInitHealth(gameState.currentPokemon);
        gameState.currentPokemon[0].originalHealth = gameState.calcInitHealth(gameState.currentPokemon);

        gameState.currentRivalPokemon[0].health = gameState.calcInitHealth(gameState.currentRivalPokemon);
        gameState.currentRivalPokemon[0].originalHealth = gameState.calcInitHealth(gameState.currentRivalPokemon);
  ...
  calcInitHealth: function calcInitHealth(user) {
